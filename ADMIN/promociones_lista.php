...
$statement = "SELECT * FROM promociones WHERE status=1 AND eliminado=0 ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>  <a class='ver-detalles-btn' href='promociones_detalles.php?id=" . $row['id'] . "'>Ver Detalles</a></td>
                <td>  <a class='editar-btn' href='promociones_editar.php?id=" . $row['id'] . "'>Editar</a></td>
              </tr>";
    }
